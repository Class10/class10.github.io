...
sockfd.sendto(str(client_a_ip) + ":" + str(client_a_port), client_requests[1])
sockfd.sendto(str(client_b_ip) + ":" + str(client_b_port), client_requests[0])
sockfd.close()
